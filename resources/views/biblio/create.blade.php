...
<div class="container card shadow py-3 px-5 mt-5">
    <div class="card-header text-center bg-white">Store Data Bibliografi</div>
    
    <div class="card-body">
      
      <form action="{{ route('biblios.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea type="textarea" id="sinopsis" name="sinopsis"
            value="{{ old('sinopsis') }} "
        ...
        <a href="{{ route('biblios.index') }}" class="btn btn-primary mb-2">
          Cancel
        </a>
      </form>
