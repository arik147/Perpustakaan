...
<div class="container card shadow py-3 px-5 mt-5">
    <div class="card-header text-center bg-white">Update Data Anggota</div>
    
    <div class="card-body">
 
      <form action="{{ route('anggotas.update',['anggota' => $anggota->id]) }}" enctype="multipart/form-data"
        method="POST">
        @method('PUT')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea type="text" id="alamat" name="alamat" placeholder="{{ old('alamat') ?? $anggota->alamat }}"
        ...
        <div class="mb-3">
          ...
          value="{{ old('password') ?? $anggota->password }}"
        ...
        <a href="{{ route('anggotas.show',['anggota' => $anggota->id]) }}" class="btn btn-warning mb-2">
          Cancel
        </a>
      </form>
