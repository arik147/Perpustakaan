...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
  ...
  <div class="container card shadow py-3 px-5 my-4">
    <div class="card-header text-center bg-white">Data Anggota</div>
      ...
      <div class="card-body">
        ...
        <div class="container d-flex flex-wrap justify-content-center my-4" style="gap: 1.5rem;">
          ...
          <a href="{{ route('anggotas.show',['anggota' => $anggota->id]) }}" class="card shadow" style="text-decoration: none; color: black; max-width: 15rem;">
        
            <img src="{{ asset('storage/' . $anggota->image) }}" class="card-img-top"> 
            <div class="card-body">
              <h4 class="mb-1 fs-6 text-start text-muted">{{$anggota->email}}</h4>
              <h2 class="fs-3 mt-2 mb-1 text-capitalize card-title text-center fw-bold">{{ $anggota->nama }}</h2>
            </div>
          </a>
          @empty
          @endforelse
